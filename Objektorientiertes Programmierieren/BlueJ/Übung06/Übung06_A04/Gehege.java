public class Gehege {
    ...
    public void fuegeTierHinzu(Tier tier) throws UeberfuellungException {
        if((tiere.length - this.anzahlTiere) > 0) {
            ...
            throw new UeberfuellungException(this, tier); //this ruft einfach dieses objekt auf, wir sind schom im gehege objekt.
        }
    }
    ...
    public static void main(String args[]) {
        ...
        Tier elefant2 = new Elefant("Elefant2", 35);
        Tier elefant3 = new Elefant("Elefant3", 10);
        Tier elefant4 = new Elefant("Elefant4", 40);
        ...
        try {
            ...
            savanne.fuegeTierHinzu(elefant2);
            savanne.fuegeTierHinzu(elefant3);
            savanne.fuegeTierHinzu(elefant4);
        } catch (UeberfuellungException exception) {
